...
Функция ТекстЗапросаНезакрытыеЧеки(СписокТаблиц)
	...
	|	СУММА(ЕСТЬNULL(СуммыПоДокументам.Сумма, СчетНаОплатуПокупателюТовары.Сумма)) КАК Сумма,
	|	ЕСТЬNULL(СуммыПоДокументам.СтавкаНДС, СчетНаОплатуПокупателюТовары.СтавкаНДС) КАК СтавкаНДС,
	|	СУММА(ЕСТЬNULL(СуммыПоДокументам.СуммаНДС, СчетНаОплатуПокупателюТовары.СуммаНДС)) КАК СуммаНДС
	|ИЗ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СуммыПоДокументам КАК СуммыПоДокументам
	...
	|	ЕСТЬNULL(СуммыПоДокументам.СтавкаНДС, СчетНаОплатуПокупателюТовары.СтавкаНДС),
