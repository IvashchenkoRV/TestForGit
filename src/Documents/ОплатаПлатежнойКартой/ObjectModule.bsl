...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Для Каждого СтрокаРасшифровки Из РасшифровкаПлатежа Цикл
		Если ТипЗнч(СтрокаРасшифровки.ПорядокОтраженияАванса) = Тип("СправочникСсылка.Патенты")
			И Не УчетПСН.ДеятельностьПоПатентуДействуетНаДату(СтрокаРасшифровки.ПорядокОтраженияАванса, Дата) Тогда
