...
Функция ПодготовитьТаблицуНДСПоРеализацииНеплательщиком(ТаблицаВзаиморасчетов, ТаблицаРеквизитов) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ВТ_НачисленныйНДС.ДокументВВалюте ИЛИ ВТ_СуммыДокументов.СуммаДокумента ЕСТЬ NULL
	...
	|	ЕСТЬNULL(ВТ_СуммыДокументов.СуммаДокумента, ВТ_НачисленныйНДС.СуммаБезНДС + ВТ_НачисленныйНДС.НДС) КАК ВалютнаяСуммаРеализации
	|ИЗ
	...
	|		И ВТ_СуммыДокументов.Дата < &ДатаНачалаПримененияНДС";
