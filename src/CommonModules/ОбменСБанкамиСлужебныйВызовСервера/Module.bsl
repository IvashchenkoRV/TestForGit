...
//    ПрограммаБанка - ПересислениеСсылка.ПрограммыБанка - вид программы банка.
//
// Возвращаемое значение:
...
// Запускает на сервере фоновое задание ожидания завершения обработки отправленных в банк документов.
//
// Параметры:
//  ДанныеСессии - Структура см. ОбменСБанкамиСлужебныйКлиентСервер.НовыеДанныеСессииОбменаСБанком
//  ИдентификаторЗаданияОжидания - Строка - идентификатор уже запущенного задания.
// 
// Возвращаемое значение:
//  Структура - см. ДлительныеОперации.ВыполнитьФункцию
//
Функция ЗапускЗаданияОжиданиеЗавершенияОбработкиДокументовБанком(Знач ДанныеСессии, ИдентификаторЗаданияОжидания = Неопределено) Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	
	НастройкаОбмена = ДанныеСессии.НастройкаОбмена;
	ИдентификаторСессии = ДанныеСессии.ИдентификаторСессии;
	УниверсальнаяДатаОбновленияСессии = ДанныеСессии.УниверсальнаяДатаОбновленияСессии;
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"ОбменСБанкамиСлужебный.ОбновитьДанныеОткрытойСесииОбмена", ДанныеСессии);
...
//
Функция ЕстьДокументыВСостоянииОбработки(НастройкаОбмена, ТолькоОбменДепозитами = Ложь) Экспорт
