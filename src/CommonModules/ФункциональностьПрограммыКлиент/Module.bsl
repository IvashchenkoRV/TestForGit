...
Процедура ПоказатьОбъектыПрепятствующиеОтключениюОпции(Элемент, ИмяЗаголовка, ФормаВладелец, ОповещениеЗакрытия = Неопределено) Экспорт
	...
	ИначеЕсли ЭтоРазделВключенияВзаимодействияСЛидами(ИмяЭлемента) Тогда
		ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте(
			ИмяЭлемента,
			ФормаВладелец,
			ОповещениеЗакрытия);
...
Процедура ЗапуститьФормированиеСпискаДокументовПрепятствующихОтключениюОпцииНаКлиенте(ИмяОпции, ФормаВладелец, ОповещениеЗакрытия = Неопределено)
	...
	ИначеЕсли ЭтоРазделВключенияВзаимодействияСЛидами(ИмяОпции) Тогда
		ПараметрыФормы.Вставить("ИмяМетода",
			"Обработки.ФункциональностьПрограммы.СформироватьСписокОбъектовПрепятствующихОтключениюИспользоватьЛиды");
	...
	ИначеЕсли ИмяОпции = "ПоступлениеНаНесколькоСкладов" Тогда
		ПараметрыФормы.Вставить("ИмяМетода", "Обработки.ФункциональностьПрограммы.СформироватьСписокОбъектовПрепятствующихОтключениюПоступлениеНаНесколькоСкладов");
...
Функция ЭтоРазделВключенияВзаимодействияСЛидами(ИмяЭлемента)
	
	Возврат ИмяЭлемента = "ПоказыватьЛидыПолныйИнтерфейс" Или ИмяЭлемента = "ПоказыватьРазделЛидыПростойИнтерфейс";
