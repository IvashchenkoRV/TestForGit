...
Функция БухгалтерскиеИтоги_Баланс2025Кв1(Организация, КонецПериодаОтчета, ИтогиПоСчетам)
	...
	СК_РасчетыПоАренде = ЗаполнениеБухгалтерскойОтчетностиИтоги.РазделенноеСальдоСчетовУчетаРасчетыПоАренде(КонецПериодаОтчета, Организация);
...
Функция НастройкиРасшифровкиПоказателейБалансаПоАренде(ОбщиеНастройки)
	...
	Возврат ЗаполнениеБухгалтерскойОтчетности.НастройкиРасшифровкиПоказателейБалансаПоАренде(ОбщиеНастройки);
