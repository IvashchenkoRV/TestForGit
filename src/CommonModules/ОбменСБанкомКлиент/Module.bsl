...
&НаКлиенте
Процедура ВыбратьИЗагрузитьФайл(Форма, Кодировка = "Windows", РежимЗагрузки = "") Экспорт
...
&НаКлиенте
Процедура ЗагрузитьВыбранныйФайл(ФайлЗагрузки,
								 Форма,
								 Кодировка = "Windows",
...
Процедура ВопросВыбратьФайлИнтерактивноЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	Если Ответ = КодВозвратаДиалога.Да Тогда
		РежимЗагрузки = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ДополнительныеПараметры, "РежимЗагрузки", "Универсальная");
