...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ПроверятьРеквизитыБрокера(ВыбраннаяФорма) Тогда
...
Процедура КомандаОК(Команда)
	...
	Если ВидВычета = ВидВычетаПоУмолчанию() Тогда
		СтруктураОтвета.Вставить("ПризнакОснованияЗаявленияВычетаИИС", "1");
		СтруктураОтвета.Вставить("Информация",  НСтр("ru = 'Инвестиционный вычет'"));
	Иначе
		СтруктураОтвета.Вставить("ПризнакОснованияЗаявленияВычетаИИС", "2");
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ВидВычета = ВидВычетаПоУмолчанию() Или Не ПроверятьРеквизитыБрокера(Форма.ВыбраннаяФорма) Тогда
	...
	Элементы.ГруппаБрокер.Видимость = ПроверятьРеквизитыБрокера(Форма.ВыбраннаяФорма);
...
&НаСервереБезКонтекста
Функция ПроверятьРеквизитыБрокера(ВыбраннаяФорма)
	
	Возврат ВыбраннаяФорма = "ФормаОтчета2025кв1";
