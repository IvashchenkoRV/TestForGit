...
Процедура ЗаполнитьНовуюФорму()
	...
	ИначеЕсли КлючНазначенияФормы = "Недвижимость" Тогда
		...
		ДоляЧислитель         = 1;
		ДоляЗнаменатель       = 2;
	ИначеЕсли КлючНазначенияФормы = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала() Тогда
		ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала();
	Иначе
...
Функция ОписаниеОперацииПоВидуИмущества(ВидИмущества)
	...
	ИначеЕсли ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала() Тогда
...
Процедура УстановитьВидимостьПоВидуИмущества(Форма)
	...
	ИначеЕсли Форма.ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала() Тогда
...
Функция КодВидаДоходаПоВидуПроданногоИмущества(ВидИмущества, ДоходОпределенПоСуммеДоговора, ВыбраннаяФорма)
	...
	ИначеЕсли ПереченьДоходовРасширен
		И ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала() Тогда
	...
	ИначеЕсли ВидИмущества = "ДолевоеСтроительство"
		Или ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаДоляУставногоКапитала() Тогда
