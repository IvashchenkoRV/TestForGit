...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИменаСобытий.Добавить("Успешная отправка");
	...
	Если ИменаСобытий.Найти(ИмяСобытия) <> Неопределено
		...
		Или (ИмяСобытия = "Завершение отправки" И ТипЗнч(Параметр.Ссылка) = Тип("СправочникСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов")) Тогда
