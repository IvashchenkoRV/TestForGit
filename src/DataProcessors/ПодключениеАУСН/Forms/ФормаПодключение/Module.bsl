...
Функция СтруктураЭлементовГруппыСервиса()
	...
	СтруктураЭлементов.Вставить("КартинкаПроверяется", "КартинкаПроверяется");
...
Процедура УправлениеФормой(Форма)
	...
	Для Каждого СостояниеПодключения Из Форма.СостоянияПодключения Цикл
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			СтруктураЭлементов.КартинкаПроверяется + ИмяЭлементов,
			"Видимость",
			СервисПроверяется);
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			...
			"Видимость",
			Не СервисПодключен И Не СервисПроверяется);
