...
Процедура УправлениеФормой()
	...
	// Временное предупреждение об отсутствии декларации по НДС со ставкой 22%
	ПредупреждатьОбОтсутствииДекларацииПоНДС = Объект.Период >= '20260101';
	Элементы.ДекорацияОбОтсутствииДекларацииПоНДС.Видимость = ПредупреждатьОбОтсутствииДекларацииПоНДС;
	Элементы.ГруппаНДСКУплатеПошаговыйПомощник.Видимость = Не ПредупреждатьОбОтсутствииДекларацииПоНДС;
	Элементы.ГруппаДекларация.Видимость = Не ПредупреждатьОбОтсутствииДекларацииПоНДС;
	Элементы.ПоказателиДляРасчетаНалога.Видимость = Не ПредупреждатьОбОтсутствииДекларацииПоНДС;
