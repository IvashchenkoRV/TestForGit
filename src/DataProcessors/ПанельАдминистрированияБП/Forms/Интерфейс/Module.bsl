...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	БлокироватьПростойИнтерфейс = ВедетсяУчетПоНесколькимОрганизациям();
...
Процедура Перезапустить(Команда)
	...
	Если ВариантИнтерфейса = "ИнтерфейсТаксиПростой" И ВедетсяУчетПоНесколькимОрганизациям() Тогда
		БлокироватьПростойИнтерфейс = Истина;
		ПриИзмененииВариантаИнтерфейса();
		Возврат;
	КонецЕсли;
...
Функция ВедетсяУчетПоНесколькимОрганизациям()
	...
	ВестиУчетПоОрганизациям = ПолучитьФункциональнуюОпцию("ВестиУчетПоОрганизациям")
		И Не Обработки.ФункциональностьПрограммы.УсловиеВыполненоВестиУчетПоОднойОрганизации(Ложь);
