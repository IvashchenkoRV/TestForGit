...
Процедура ДокументыПоСкладу(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("ЖурналДокументов.СкладскиеДокументы.ФормаСписка", ЭтотОбъект, ПараметрыФормы);
...
Процедура ПередачаСотрудникам(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("ЖурналДокументов.ПередачаМатериалов.ФормаСписка", ЭтотОбъект, ПараметрыФормы);
...
Процедура БезвозмезднаяПередача(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.ПередачаТоваров.Форма.ФормаСпискаБезвозмезднаяПередача", ЭтотОбъект, ПараметрыФормы);
...
Процедура КомплектацияНоменклатуры(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.КомплектацияНоменклатуры.ФормаСписка", ЭтотОбъект);
...
Процедура ИнвентаризацияТоваров(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.ИнвентаризацияТоваровНаСкладе.ФормаСписка", ЭтотОбъект);
