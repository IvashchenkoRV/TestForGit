...
Процедура СчетаПокупателям(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.СчетНаОплатуПокупателю.ФормаСписка", ЭтотОбъект);
...
Процедура Реализация(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.РеализацияТоваровУслуг.ФормаСписка", ЭтотОбъект);
...
Процедура СчетаФактурыВыданные(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.СчетФактураВыданный.ФормаСписка", ЭтотОбъект);
...
Процедура КорректировкаРеализации(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.КорректировкаРеализации.ФормаСписка", ЭтотОбъект);
...
Процедура РеализацияОтгруженныхТоваров(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.РеализацияОтгруженныхТоваров.ФормаСписка", ЭтотОбъект);
...
Процедура ВозвратыОтПокупателей(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.ВозвратТоваровОтПокупателя.ФормаСписка", ЭтотОбъект);
...
Процедура РозничныеПродажи(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("ЖурналДокументов.РозничныеПродажи.ФормаСписка", ЭтотОбъект);
...
Процедура ВсеНеоплаченныеСчета(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Обработка.ОжидаемаяОплатаОтПокупателей.Форма", ЭтотОбъект);
...
Процедура КоммерческиеПредложения(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.КоммерческоеПредложение.ФормаСписка", ЭтотОбъект);
...
Процедура АктыОРасхожденияхПолученные(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.АктОРасхожденияхПолученный.ФормаСписка", ЭтотОбъект);
...
Процедура ЗагрузкаПродажBNovo(Команда)
	...
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("РегистрСведений.НастройкиИнтеграцииBnovo.ФормаСписка", ЭтотОбъект, ПараметрыФормы);
КонецПроцедуры
