...
Процедура АдаптироватьМКШапкаФормы()
	...
	Элементы.ГруппаАкселераторыМК.Видимость = Не ОбщегоНазначенияБП.ЭтоИнтерфейсИнтеграцииСБанком();
...
Процедура ДекорацияНовыйУПДНажатие(Элемент)
	...
	СписокВыбораОперации.Добавить("Товары");
	СписокВыбораОперации.Добавить("Услуги");
...
Процедура КомандыМК_Создать_Завершение(ВыбранныйЭлемент, ДопПараметры) Экспорт
	...
	Если ВыбранныйЭлемент.Значение = "Товары" Тогда
		СоздатьУПДТовары(Неопределено);
	ИначеЕсли ВыбранныйЭлемент.Значение = "Услуги" Тогда
