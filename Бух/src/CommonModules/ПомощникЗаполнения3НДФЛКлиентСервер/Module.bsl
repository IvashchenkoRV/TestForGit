...
// Возвращает идентификатор обозначения вида дохода от продажи доли в уставном капитале
//
// Возвращаемое значение:
//   Строка - Вид дохода от продажи доли в уставном капитале
//
Функция ВидДоходаДоляУставногоКапитала() Экспорт
	
	Возврат "ДоляУставногоКапитала";
