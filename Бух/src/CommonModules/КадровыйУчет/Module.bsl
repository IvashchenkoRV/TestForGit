...
Функция ТаблицаНачисленийСотрудниковПоВременнойТаблице(МенеджерВременныхТаблиц, ПараметрыВременнойТаблицы, ИспользоватьКраткиеПредставления = Истина, ВыводитьДенежныеПоказателиСВалютой = Ложь, ФормироватьСПериодичностьДень = Истина) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты")
		...
		ОписанияНачислений = ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ПараметрыВременнойТаблицы, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень);
...
Функция ПараметрыВременнойТаблицыДляОписанияСоставаНачислений() Экспорт
	
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений = Новый Структура;
	
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений.Вставить("ИмяВТСотрудникиПериоды");
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений.Вставить("ИмяПоляПериод", "Период");
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений.Вставить("ИмяПоляСотрудник", "Сотрудник");
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений.Вставить("ИмяПоляНачисление", "");
	ПараметрыВременнойТаблицыДляОписанияСоставаНачислений.Вставить("ИмяПоляДатаОкончания", "");
	
	Возврат ПараметрыВременнойТаблицыДляОписанияСоставаНачислений;
	
КонецФункции

Функция ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ПараметрыВременнойТаблицы, ИспользоватьКраткиеПредставления = Истина, ВыводитьДенежныеПоказателиСВалютой = Ложь, ФормироватьСПериодичностьДень = Истина) Экспорт
	
	Возврат КадровыйУчетВнутренний.ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ПараметрыВременнойТаблицы, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень);
...
Процедура ВывестиНаПечатьТ1(ПараметрыПечати, ДокументРезультат, ДанныеСсылок, МакетПечатнойФормы, ИдентификаторыМакета = Неопределено, ОбъектыПечати = Неопределено) Экспорт
	...
	ПараметрыВременнойТаблицы = ПараметрыВременнойТаблицыДляОписанияСоставаНачислений();
	ПараметрыВременнойТаблицы.ИмяВТСотрудникиПериоды = "ВТСотрудникиПериоды";
	НачисленияСотрудников = ТаблицаНачисленийСотрудниковПоВременнойТаблице(Запрос.МенеджерВременныхТаблиц, ПараметрыВременнойТаблицы);
