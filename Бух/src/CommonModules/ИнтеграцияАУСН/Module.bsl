...
Функция ВыполнитьОбменССервисомЛКАУСН() Экспорт
	...
	ОтправитьРасчетыНДФЛАУСНВБанк(Ошибки, Истина);
	...
	ПолучившиеОтветСервиса = НовыйКлючиСостоянияОбмена();
	...
	ПараметрыОбмена.Вставить("ОписаниеОшибокОтправки", Ошибки);
	ПараметрыОбмена.Вставить("ОписаниеОшибок", НовыйОписаниеОшибок());
	ПараметрыОбмена.Вставить("ПолучившиеОтветСервиса", ПолучившиеОтветСервиса);
	
	ЗаписатьСостояниеОбмена(ПараметрыОбмена);
...
//
Процедура ОтправитьРасчетыНДФЛАУСНВБанк(Ошибки, ПрямаяВыгрузкаВФНС = Ложь) Экспорт
