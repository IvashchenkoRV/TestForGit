...
Функция ПреобразоватьДанныеОтчетаОВыкупе(ПараметрыОтчета, ДанныеОтчета)
	...
	Контрагент              = КонтрагентДоговор.Контрагент;
	ДоговорКонтрагента      = Справочники.ДоговорыКонтрагентов.ПустаяСсылка();
	РаботаСДоговорамиКонтрагентовБП.УстановитьДоговорКонтрагента(ДоговорКонтрагента, Контрагент, Организация, ЗначениеВМассив(Перечисления.ВидыДоговоровКонтрагентов.СПокупателем));
	Дата                    = ПараметрыОтчета.ОкончаниеПериода;
