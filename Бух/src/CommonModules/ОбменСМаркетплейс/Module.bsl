...
// Определяет существуют ли настроенные интеграции с маркетплейсами через АПИ
// 
// Возвращаемое значение:
//  Булево
//
Функция ЕстьНастроенныеПодключенияЧерезАПИ() Экспорт
	...
	|		ПО НастройкиИнтеграцииМаркетплейс.Владелец = ВТ_Организации.Ссылка
	|ГДЕ
