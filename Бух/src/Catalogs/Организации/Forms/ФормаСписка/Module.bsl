...
Процедура АдаптироватьМККоманднаяПанельФормы()
	...
	МетаданныеОрганизации = Метаданные.Справочники.Организации;
	МожноРедактировать = ПравоДоступа("Редактирование", МетаданныеОрганизации);
	...
	ИначеЕсли Элементы.ФормаСоздать.Видимость Тогда
		КомандыПоля.КомандаСоздать = "ФормаСоздать";
	ИначеЕсли Элементы.ГруппаСоздать.Видимость Тогда
