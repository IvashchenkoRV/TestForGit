...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	Если ПоказыватьКолонкиСВзаиморасчетами
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ЗадолженностьПоставщику.Видимость = Форма.ПоказыватьКолонкиСВзаиморасчетами
		И Форма.ВестиУчетРасчетовСКонтрагентами И Форма.ДоступенОтчетЗадолженностьПоставщику;
	Элементы.ЗадолженностьПокупателя.Видимость = Форма.ПоказыватьКолонкиСВзаиморасчетами
		И Форма.ВестиУчетРасчетовСКонтрагентами  И Форма.ДоступенОтчетЗадолженностьПокупателя;
	Элементы.НеоплаченныеСчета.Видимость       = Форма.ПоказыватьКолонкиСВзаиморасчетами
		И Форма.ДоступенОтчетАнализНеоплаченныхСчетов;
	...
	// Колонки с остатками по взаиморасчетам
	Элементы.КонтрагентЗадолженностьПокупателя.Видимость = Форма.ДоступенОтчетЗадолженностьПокупателя;
	Элементы.КонтрагентЗадолженностьПоставщику.Видимость = Форма.ДоступенОтчетЗадолженностьПоставщику;
	Элементы.КонтрагентНеоплаченныеСчета.Видимость       = Форма.ДоступенОтчетАнализНеоплаченныхСчетов;
...
Процедура НастроитьОперацииПодменюОтчеты()
	...
	ДоступенОтчетЗадолженностьПокупателя = ЕстьПравоОтчетЗадолженностьПокупателей;
	...
	ДоступенОтчетЗадолженностьПоставщику = ЕстьПравоОтчетЗадолженностьПоставщикам;
	...
	ДоступенОтчетАнализНеоплаченныхСчетов = ЕстьПравоОтчетАнализНеоплаченныхСчетовПокупателям;
