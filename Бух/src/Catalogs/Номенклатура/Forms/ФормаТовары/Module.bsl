...
Процедура ДобавитьВТОстаткиВСхему(Схема)
	...
	ИсточникВыборки.Источник.Параметры[3].Выражение = Новый ВыражениеСхемыЗапроса("{Субконто2 = &Склад}");
...
Функция РезультатЗапросаОстаткиЦены(ПараметрыЗапросаОстаткиЦены, НоменклатураКРасчетуОстатковЦен, ПолучатьОстатки = Ложь)
	...
	Если Не ПараметрыЗапросаОстаткиЦены.ПоказыватьОстатки Или Не ПолучатьОстатки Тогда
