...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ФормаЗагрузитьИзФайлаМегамаркет.Видимость = ПолучитьФункциональнуюОпцию("ВедетсяРозничнаяТорговля")
	...
	Если ОбменСМаркетплейс.РазрешитьУдалениеЗаписейЖурналаОбмена() Тогда
...
Процедура УправлениеВидимостью()
	...
	Элементы.ФормаНастройкаАвтозагрузки.Видимость = ОбменСМаркетплейс.ЕстьНастроенныеПодключенияЧерезАПИ();
