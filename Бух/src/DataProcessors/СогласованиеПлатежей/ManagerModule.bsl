...
Функция ЗапросДанныеПлатежей(ДанныеСвойствДляЗапроса, ПлатежноеПоручение = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ДанныеСвойствДляЗапроса.БанковскийСчет) Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&СчетОрганизации","ПлатежноеПоручение.СчетОрганизации = &СчетОрганизации");
	Иначе
...
Функция СформироватьПредставлениеСтрокиПлатежноеПоручение(Состояние, НомерДокумента, ДатаДокумента, ДляПечати = Ложь) Экспорт
